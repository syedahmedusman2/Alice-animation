...
function App() {
  ...
  useLayoutEffect(() => {
    ...
    // Scenery
      ...
      window.addEventListener("click2", goslower);
  })
  ...
  return (
    <div className="container">
      ...
      <div className="scenery background1" ref={background}>
        ...
        <img className="treeback2" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/palm1_small.png" alt=" " />
      {/* <button onClick={()=>alice.playbackRate -= 0.1}>Slow Down</button> */}
      </div>
    </div>
  );
}
